...
CREATE TABLE IF NOT EXISTS donations (
  ...
  payment_method text NOT NULL CHECK (payment_method IN ('stripe', 'mpesa', 'paystack')),
...
CREATE TABLE IF NOT EXISTS payment_logs (
  ...
  provider text NOT NULL CHECK (provider IN ('stripe', 'mpesa', 'paystack')),
...
INSERT INTO campaigns (title, description, target_amount, raised_amount, status) VALUES
  ...
  (
    ...
    'Bringing affordable broadband internet to 20 rural schools across Kenya. We cover infrastructure, hardware, and a 3-year connectivity subscription so students stay online without interruption.',
    300000,
    87500,
    'active'
  )
